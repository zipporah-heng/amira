const STEPS = [
  ...
  { t: "Benchmark prepared for human validation", d: "A held-out benchmark of verbatim passages carries rule-drafted labels awaiting independent human review. Evaluation is pending — no accuracy has been measured or claimed." },
